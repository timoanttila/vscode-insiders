...
- fix: address issue of black cursor in ipynb file for soft variant [#124](https://github.com/caumeira/dark-material-dracula/issues/124)
...
- Add activitybar colors. [#121](https://github.com/caumeira/dark-material-dracula/issues/121)

### Patch

- Fix cursor color in `ipynb` files. [#124](https://github.com/caumeira/dark-material-dracula/issues/124)

## 2.18.1

### Patch

- Fix class keyword highlighting in babel syntax. [#118](https://github.com/caumeira/dark-material-dracula/issues/118)
...
- Add support for `statusBarItem.remoteBackground` (currently available in insiders) [#105](https://github.com/caumeira/dark-material-dracula/issues/105)
...
- Fix incorrect highlighting for variable names in JavaScript (and friends) in the body of default-exported classes/functions/etc. (#88, [#82](https://github.com/caumeira/dark-material-dracula/issues/82))

## 2.14.1

### Patch

- Fix the incorrect syntax highlighting of "pseudo-constants" in `tsx` files. [#84](https://github.com/caumeira/dark-material-dracula/issues/84)
...
- Add styling to the new breadcrumbs UI elements. [#85](https://github.com/caumeira/dark-material-dracula/issues/85)

### Fix

- Fix the incorrect syntax highlighting of javascript/typescript "pseudo-constants" (a change that recently was added to the syntaxes). [#84](https://github.com/caumeira/dark-material-dracula/issues/84)
...
- Fix color of editor rulers to match indent guides. [#79](https://github.com/caumeira/dark-material-dracula/issues/79)
...
- Fix warning color decorations in the explorer. [#77](https://github.com/caumeira/dark-material-dracula/issues/77)

## 2.10.0

- Add support for new highlighted indent guides. [#74](https://github.com/caumeira/dark-material-dracula/issues/74)
...
- Implement improved ANSI colors for integrated terminal. [#66](https://github.com/caumeira/dark-material-dracula/issues/66)
...
- Italicize html attribute names so that Operator Mono font users can have their fancy pseudo-cursive. [#62](https://github.com/caumeira/dark-material-dracula/issues/62)
...
- Improve terminal white contrast. [#59](https://github.com/caumeira/dark-material-dracula/issues/59)
...
- Change codelens from `orange` to `comment` color so it's less distracting. [#57](https://github.com/caumeira/dark-material-dracula/issues/57)
...
**Notes:** Mac users should have a better experience with this one. Feel free to leave any critiques/comments on [#30](https://github.com/caumeira/dark-material-dracula/issues/30) on github and we'll go from there.

## 2.1.2

### Patch

- Fix broken `OCaml` type highlighting. [#44](https://github.com/caumeira/dark-material-dracula/issues/44)
...
- Fix extension install/update button color. [#43](https://github.com/caumeira/dark-material-dracula/issues/43)
...
- Apply theme to notification panel. [#35](https://github.com/caumeira/dark-material-dracula/issues/35)
- Apply theme to buttons.

### Patch

- Make colorization of python raw string literals more consistent. [#36](https://github.com/caumeira/dark-material-dracula/issues/36)
- Switch from yellow to green for current highlight match to improve contrast over purple tokens. [#33](https://github.com/caumeira/dark-material-dracula/issues/33)
...
- Add `Dracula Soft` theme variant (beta - comments/critiques welcomed). [#30](https://github.com/caumeira/dark-material-dracula/issues/30)

### Patch

- Lighten ANSI `color0` and `color8` so that they're more legible in the terminal. [#32](https://github.com/caumeira/dark-material-dracula/issues/32)
...
- Small adjustements to `findMatchHighlight` and `findRangeHighlight` in an attempt to improve contrast. [#31](https://github.com/caumeira/dark-material-dracula/issues/31)
...
- Upgrade from experimental UI theme scopes (requires VSCode `v1.12.0`). [#28](https://github.com/caumeira/dark-material-dracula/issues/28)
...
- Adjust TextMate scopes for strings so that VSCode "Expand Select" function works properly. Closes [#24](https://github.com/caumeira/dark-material-dracula/issues/24) (HT: @ajitid)
...
- Fix status bar background color when there's no folder selected. Closes [#20](https://github.com/caumeira/dark-material-dracula/issues/20) (HT: @23doors)
...
- Fix debug panel background color. Closes [#19](https://github.com/caumeira/dark-material-dracula/issues/19) (HT: @23doors)
- Add contrast to the Activity Bar. (HT: @rajasimon)
- Adjust find match highlight to be differentiable from selection. Closes [#18](https://github.com/caumeira/dark-material-dracula/issues/18) (HT: @nguyenhuumy)
