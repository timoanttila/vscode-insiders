...
`;var st=Object.defineProperty,ct=Object.getOwnPropertyDescriptor,at=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?ct(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&st(t,o,i),i};let ht=class extends Xe{constructor(){super(...arguments),this.full=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}render(){const e=Le`<slot></slot>`;return null!=this.href?Le`<a href=${this.href}>${e}</a>`:e}};ht.styles=[it,Y`
			:host {
		...
		`],at([ot({type:Boolean,reflect:!0})],ht.prototype,"full",2),at([ot()],ht.prototype,"href",2),at([ot({reflect:!0})],ht.prototype,"role",1),at([ot()],ht.prototype,"appearance",2),at([ot({type:Number,reflect:!0})],ht.prototype,"tabIndex",2),ht=at([et("gk-button")],ht);var lt=Object.defineProperty,bt=Object.getOwnPropertyDescriptor,ft=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?bt(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&lt(t,o,i),i};let dt=class extends Xe{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};dt.styles=Y`
		:host {
