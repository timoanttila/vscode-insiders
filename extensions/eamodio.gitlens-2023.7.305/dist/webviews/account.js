...
`;var bt=Object.defineProperty,ut=Object.getOwnPropertyDescriptor,dt=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?ut(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&bt(t,o,i),i};let ft=class extends tt{constructor(){super(...arguments),this.full=!1,this.tabIndex=0}get role(){return this.href?"link":"button"}render(){const e=Oe`<slot></slot>`;return null!=this.href?Oe`<a href=${this.href}>${e}</a>`:e}};ft.styles=[ht,oe`
			:host {
		...
		`],dt([it({type:Boolean,reflect:!0})],ft.prototype,"full",2),dt([it()],ft.prototype,"href",2),dt([it({reflect:!0})],ft.prototype,"role",1),dt([it()],ft.prototype,"appearance",2),dt([it({type:Number,reflect:!0})],ft.prototype,"tabIndex",2),ft=dt([nt("gk-button")],ft);var pt=Object.defineProperty,gt=Object.getOwnPropertyDescriptor,mt=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?gt(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&pt(t,o,i),i};let vt=class extends tt{constructor(){super(...arguments),this.editor=!1}render(){return Oe`<div class="group"><slot></slot></div>`}};vt.styles=[ht,oe`
			:host {
				display: block;
				max-width: 30rem;
				margin-right: auto;
		...
		`],mt([it({type:Boolean})],vt.prototype,"editor",2),vt=mt([nt("button-container")],vt);var yt=Object.defineProperty,wt=Object.getOwnPropertyDescriptor,_t=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?wt(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&yt(t,o,i),i};let $t=class extends tt{constructor(){super(...arguments),this.icon="",this.modifier="",this.size=16}updated(e){e.has("size")&&this.style.setProperty("--code-icon-size",`${this.size}px`),super.update(e)}};$t.styles=oe`
		:host {
	...
	`,_t([it()],$t.prototype,"icon",2),_t([it()],$t.prototype,"modifier",2),_t([it({type:Number})],$t.prototype,"size",2),$t=_t([nt("code-icon")],$t);var kt=Object.defineProperty,At=Object.getOwnPropertyDescriptor,xt=(e,t,o,n)=>{for(var r,i=n>1?void 0:n?At(t,o):t,s=e.length-1;s>=0;s--)(r=e[s])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&kt(t,o,i),i};let Pt=class extends tt{constructor(){super(...arguments),this.image="",this.name="",this.days=0,this.state=l.Free,this.plan=""}get daysRemaining(){return this.days<1?"<1 day":function(e,t,o){if(null==o)return`${t} ${e}${1===t?"":"s"}`;const n=1===t?e:o.plural??`${e}s`;return o.only?n:`${0===t?o.zero??t:o.format?.(t)??t}${o.infix??" "}${n}`}("day",this.days)}get planName(){switch(this.state){case l.Free:case l.FreePreviewTrialExpired:case l.FreePlusTrialExpired:return"GitLens Free";case l.FreeInPreviewTrial:case l.FreePlusInTrial:return"GitLens Pro (Trial)";case l.VerificationRequired:return`${this.plan} (Unverified)`;default:return this.plan}}get daysLeft(){switch(this.state){case l.FreeInPreviewTrial:case l.FreePlusInTrial:return`, ${this.daysRemaining} left`;default:return""}}get hasAccount(){return null!=(e=this.state)&&0!==e&&2!==e&&1!==e;var e}renderAccountInfo(){return this.hasAccount?Oe`
		...
		`:Be}renderAccountState(){switch(this.state){case l.VerificationRequired:return Oe`
				...
				`}return Be}render(){return Oe`${this.renderAccountInfo()}${this.renderAccountState()}`}};Pt.styles=[ht,lt,oe`
			:host {
				display: block;
